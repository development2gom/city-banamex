...
$crAuthor = "&copy; Brightstar ".date("Y");
...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: <?=$bgBody?>">
  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: <?= $bgBodyWmin ?>;margin: 0 auto;background-color: <?=$bgBody?>;width: 100%" cellpadding="0" cellspacing="0">
    ...
    <div style="background-color: <?=$bgHeader?>;">
      <div style="Margin: 0 auto;min-width: <?= $bgBodyWmin ?>;max-width: <?= $bgBodyWmax ?>;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;" class="block-grid ">
...
<!--[if mso]></td></tr></table><![endif]-->
    ...
    <div style="font-size: <?= $fontSize16 ?>;line-height:24px;font-family:'Verdana', Georgia, Times, 'Times New Roman', serif;color:#555555;text-align:left;"><p style="margin: 0;font-size: <?= $fontSize16 ?>;line-height: 28px;text-align: left"><span style="font-size: <?= $fontSize24 ?>; font-weight: bold; color: <?= $colorTitle ?>; line-height: 48px;">
    Bienvenido <?= $user ?> </span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
	...
	<div style="line-height:200%;color:#555555;font-family:'Verdanaf', Georgia, Times, 'Times New Roman', serif; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 10px;">	
        <div style="line-height:24px;color:<?= $colorText ?>;font-family:'Verdanaf', Georgia, Times, 'Times New Roman', serif;text-align:left;">
            <p style="margin: 0;line-height: 24px;text-align: justify;"><span style="font-size: <?= $fontSize16 ?>; line-height: 32px;">
            Este correo es para notificarte que <strong style="font-family: Verdana;  font-style: italic; font-weight: bold;">has sido 
              agregado</strong> al portal de Bright Star. 
             </span></p>
            <p style="margin: 0;line-height: 24px;text-align: left;" dir="ltr">&#160;<br></p>
      
            <p style="margin: 0;font-size: <?= $fontSize16 ?>;line-height: 28px;text-align: left"><span style="font-size: <?= $fontSize16 ?>; font-weight: bold; color: <?= $colorSubtitle ?>; line-height: 30px; text-align: left;">
            Importante.</span></p>
            <p style="margin: 0;line-height: 24px;text-align: justify;"><span style="font-size: <?= $fontSize16 ?>; line-height: 32px;">
            Para acceder al sistema conserva este correo, es necesario ingreses tu usuario y contraseña mismos que te compartimos a continuación:</span></p>
            <p style="margin: 0;line-height: 24px;text-align: left;" dir="ltr">&#160;<br></p>
            <p style="margin: 0;line-height: 24px;text-align: left"><span style="font-size: <?= $fontSize16 ?>; line-height: 32px;">
            Usuario:</span></p><p style="margin: 0;line-height: 24px;text-align: left"></p>
            <p style="margin: 0;line-height: 24px;text-align: left"><span style="color: <?= $colorLink ?>; font-size: <?= $fontSize14 ?>;">
            <?= $usuario ?></span></p><p style="margin: 0;line-height: 24px;text-align: left"></p>
            <p style="margin: 0;line-height: 24px;text-align: left;" dir="ltr">&#160;<br></p>
            <p style="margin: 0;line-height: 24px;text-align: left"><span style="font-size: <?= $fontSize16 ?>; line-height: 32px;">
            Contraseña:</span></p><p style="margin: 0;line-height: 24px;text-align: left"></p>
            <p style="margin: 0;line-height: 24px;text-align: left"><span style="color: <?= $colorLink ?>; font-size: <?= $fontSize14 ?>;">
            <?= $password ?></span></p><p style="margin: 0;line-height: 24px;text-align: left"></p>
...
<div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:30px;">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:30px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?=$url?>" style="height:35pt; v-text-anchor:middle; width:196pt;" arcsize="13%" strokecolor="#E33032" fillcolor="#E33032"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Verdanaf', Georgia, Times, 'Times New Roman', serif; font-size:16px;"><![endif]-->
    <a href="<?=$url?>" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: <?= $btnText ?>; background-color: <?= $btnBg ?>; border-radius: 6px; -webkit-border-radius: 6px; -moz-border-radius: 6px; max-width: 262px; width: 222px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 10px; padding-right: 20px; padding-bottom: 10px; padding-left: 20px; font-family: 'Verdanaf', Georgia, Times, 'Times New Roman', serif;mso-border-alt: none; font-weight: 300;">
      <span style="line-height:24px;"><span style=" line-height: 32px; font-size: <?= $fontSize16 ?>" data-mce-style=" line-height: 32px; color: <?= $btnText ?>;">
      Ingreso automático al portal</span></span>
    </a>
